...
<nav>
    <ul class="breadcrumb">
      ...
      <li><a href="science_fiction.php">Science-fiction</a></li>
  ...
  <div class="box">
    <h3 class="book-heading" >SCIENCE-FICTION BOOKS</h3>
    ...
    <?php 
          ...
          $query="select * from book where category='Science fiction' ";
    ...
    <div class="books-box" id="filter">
      <form action="science_fiction.php" method="POST">
