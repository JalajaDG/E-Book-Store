...
<nav>
    <ul class="breadcrumb">
      ...
      <li><a href="mystery_thriller.php">Mystery Thriller</a></li>
  ...
  <div class="box">
    <h3 class="book-heading ">MYSTERY THRILLER BOOKS</h3>
    ...
    <?php 
          ...
          $query="select * from book where category='Mystery and thriller' ";
    ...
    <div class="books-box" id="filter">
      <form action="mystery_thriller.php" method="POST">
